    ...
    return (
        <>
            ...
            >
                ...
                <kbd
                    className='pointer-events-none gap-1 inline-flex h-5 select-none items-center rounded border bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground ml-auto'
                >
